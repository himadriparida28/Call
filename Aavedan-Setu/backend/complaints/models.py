...
class Complaint(BaseModel):
    ...
    # NGO Sahayak & Assisted Citizen Filing
    is_assisted_filing = models.BooleanField(
        default=False,
    )

    assisted_by_ngo_name = models.CharField(
        max_length=200,
        blank=True,
        null=True,
    )
    ...
    # 3rd-Party NGO Social Audit & Verification
    is_ngo_audited = models.BooleanField(
        default=False,
    )

    ngo_auditor_name = models.CharField(
        max_length=200,
        blank=True,
        null=True,
    )

    ngo_audit_remarks = models.TextField(
        blank=True,
        null=True,
    )
...
class CivicProject(BaseModel):
    ...
    # 3rd-Party NGO Social Audit & CSR Co-Funding
    is_ngo_audited = models.BooleanField(default=True)
    ngo_auditor_name = models.CharField(max_length=200, blank=True, null=True, default="Jan Sahas Social Audit Team")
    ngo_audit_remarks = models.TextField(blank=True, null=True, default="Physical on-ground site inspection verified by certified NGO social auditor.")
    is_csr_supported = models.BooleanField(default=True)
    csr_sponsor_name = models.CharField(max_length=200, blank=True, null=True, default="Tata Trusts & Local CSR Pool")
    csr_pledged_amount = models.DecimalField(max_digits=12, decimal_places=2, default=50000.00)
